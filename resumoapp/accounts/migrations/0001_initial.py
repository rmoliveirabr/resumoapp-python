    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-_]+$'), 'O nome de usuário só pode conter letras, dígitos ou @/./+/-/_', 'invalid')], verbose_name='Nome do Usuário')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateField(auto_now_add=True, verbose_name='Criada em')),
